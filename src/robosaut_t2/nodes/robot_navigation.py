...
from std_msgs.msg import String  # Enables the use of the string message type
from geometry_msgs.msg import Twist  # Twist is linear and angular velocity
from sensor_msgs.msg import LaserScan  # Handles LaserScan messages to sense distance to obstacles (i.e. walls)        
from geometry_msgs.msg import Pose  # Handle Pose messages
from std_msgs.msg import Float64MultiArray  # Handle float64 arrays
from rclpy.qos import qos_profile_sensor_data  # Handles quality of service for LaserScan data
